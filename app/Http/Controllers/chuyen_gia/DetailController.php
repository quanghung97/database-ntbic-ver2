...
class DetailController extends Controller
{
    ...
    protected function index($link)
    {
        ...
        */
        $datas = chuyen_gia_khcn::select('id','ho_va_ten','hoc_vi','nam_sinh','chuyen_nganh','co_quan','huong_nghien_cuu','link_anh','Sl_congTrinh_baiBao','linkid','tinh_thanh','dia_chi_co_quan')->where('linkid',$link)->first();
