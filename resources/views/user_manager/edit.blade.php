		...
		<form id="form_iconic_validation" method="post">
			...
			<div class="form-group">
				...
				<div class="input-with-icon  right">
					<i class=""></i>
					<input type="text" name="fullname" id="form1Name" class="form-control" value="{{ $user->fullname }}">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="input-with-icon  right">
					<i class=""></i>
					<input type="email" name="email" id="form1Name" class="form-control" value="{{ $user->email }}">
				</div>
			</div>
			<div class="form-group">
