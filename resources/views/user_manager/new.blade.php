		...
		<form id="form_iconic_validation" method="post">
			...
			<div class="form-group">
				...
				<div class="input-with-icon  right">
					<i class=""></i>
					<input type="text" name="fullname" id="form1Name" class="form-control" value="{{ old('fullname') }}">
				</div>
			</div>
			<div class="form-group">
				
				<label class="form-label">Tên tài khoản <span style="color: red; font-weight: bold">*</span></label>
				<p class="text-error">{!! $errors->first('username') !!}</p>
				<div class="input-with-icon  right">
					<i class=""></i>
					<input type="text" name="username" id="form1Name" class="form-control" value="{{ old('username') }}">
				</div>
			</div>
			<div class="form-group">
				<label class="form-label">Email <span style="color: red; font-weight: bold">*</span></label>
				<p class="text-error">{!! $errors->first('email') !!}</p>
				<div class="input-with-icon  right">
					<i class=""></i>
					<input type="email" name="email" id="form1Name" class="form-control" value="{{ old('email') }}">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-actions">
				<div class="pull-right">
					...
					<button type="button" class="btn btn-white btn-cons">Hủy</button>
				</div>
			</div>
		</form>
	</div>
