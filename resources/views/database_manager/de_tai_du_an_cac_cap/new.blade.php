	...
	<div class="tab-pane" id="tab1FollowUs">
		<div class="row column-seperation">
			<div class="col-md-12">
				...
				<a href="{{ URL::asset('storage/app/private/demo_de_tai_du_an_cac_cap.xlsx') }}"><button type="button" class="btn btn-primary" style="float:right;">Tải file excel mẫu</button></a>
